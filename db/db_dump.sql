...
--
-- Host: localhost    Database: wooberly_v_2_2_1
-- ------------------------------------------------------
...
CREATE TABLE `Booking` (
  ...
  `isMultipleStops` tinyint(1) DEFAULT '0',
  `multipleStopsCount` int(11) DEFAULT '0',
  `distanceType` enum('mile','km') DEFAULT 'mile',
  `allowedWaitingTime` int(11) DEFAULT '0',
  `adminId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `isTripCancelledByAdmin` tinyint(1) DEFAULT '0',
...
CREATE TABLE `BookingHistory` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `cancelledByAdminId` char(36) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `BookingLocations`
--

DROP TABLE IF EXISTS `BookingLocations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BookingLocations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bookingId` int(11) NOT NULL,
  ...
  `locationStatus` enum('pending','completed') DEFAULT 'pending',
  `locationDistance` float DEFAULT NULL,
  `locationDistanceType` enum('km','mile') DEFAULT 'mile',
  `locationUpdatedAt` datetime DEFAULT NULL,
  `previousLocation` text CHARACTER SET utf8mb4,
  `locationDuration` float DEFAULT NULL,
  `locationType` enum('pickup','drop','stop') NOT NULL,
  `locationReachedAt` datetime DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `BookingLocations`
--

LOCK TABLES `BookingLocations` WRITE;
/*!40000 ALTER TABLE `BookingLocations` DISABLE KEYS */;
/*!40000 ALTER TABLE `BookingLocations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ScheduleBookingHistory` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `cancelledByAdminId` char(36) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SiteSettings` VALUES (1,'Site Name','siteName','Your Site','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(2,'Logo Height','logoHeight','34','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(3,'Logo Width','logoWidth','140','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(4,'Site Title','siteTitle','Your Site Title','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(5,'Meta Description','metaDescription','Your Site Meta Description','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(6,'Facebook Link','facebookLink','https://www.facebook.com/yoursite','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(7,'Twitter Link','twitterLink','https://twitter.com/yoursite','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(8,'Youtube Link','youtubeLink','https://www.youtube.com/yoursite','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(9,'Instagram Link','instagramLink','https://www.instagram.com/yoursite','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(10,'Meta Keyword','metaKeyword','Your Site Meta Keyword','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(11,'Home Logo','homeLogo','3ae636aa7d8f90db5a176099461d7dda.png','site_settings','2020-02-10 13:05:03','2021-10-08 09:16:26'),(12,'App Force Update','appForceUpdate','true','appSettings','2021-01-11 07:22:55','2021-10-08 09:31:52'),(13,'Rider Android Version','riderAndroidVersion','1.0','appSettings','2021-01-11 07:22:55','2021-10-08 09:31:52'),(14,'Rider iOS Version','riderIosVersion','1.0','appSettings','2021-01-11 07:22:55','2021-10-08 09:31:52'),(15,'Driver Android Version','driverAndroidVersion','1.0','appSettings','2021-01-11 07:22:55','2021-10-08 09:31:52'),(16,'Driver iOS Version','driverIosVersion','1.0','appSettings','2021-01-11 07:22:55','2021-10-08 09:31:52'),(17,'Stripe Publishable Key','stripePublishableKey','pk_test_C5ukBJM7qr5P1F8dY4XKhdyp','appSettings','2021-05-21 08:28:51','2021-10-08 09:31:52'),(18,'Preferred Distance Type','preferredDistanceType','km','appSettings','2021-08-17 11:36:46','2021-10-08 09:31:52'),(19,'Multiple Stops Waiting Time','multipleStopsWaitingTime','1','appSettings','2021-08-17 11:36:46','2021-10-08 09:31:52'),(20,'Distance','distance','1','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(21,'Duration','duration','1','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(22,'Estimated Price','estimatedPrice','1','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(23,'Pick-up Location','pickupLocation','1','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(24,'Destination Location','destinationLocation','1','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(25,'Driver Android App','sleepDriverAndroid','0','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(26,'Driver iOS App','sleepDriverios','0','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(27,'Favicon','favicon','b8b335062a1a07817332196db4337fd7.png','site_settings','2021-10-07 17:04:46','2021-10-08 09:16:26'),(28,'Contact Phone Number','contactPhoneNumber','00000000000','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:52'),(29,'Contact Email','contactEmail','support@yourwebsite.com','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:53'),(30,'Skype','skype','yourwebsite','appSettings','2021-10-07 17:04:46','2021-10-08 09:31:53');
...
CREATE TABLE `User` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  `adminId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `userTypeUpdated` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-01-11  8:28:33
