                    ...
                    <Col xl={4} lg={12} md={12} sm={12} xs={12}>
                        <div className={s.box}>
                            ...
                            <div className={s.totalCss}>
                               <div className={s.displayTable}>
                                    <div className={s.displayTableRow}>
                                        <div className={cx(s.displayTableCell, s.widthText, s.textCenterDashboard, 'textCenterDashboardRTL')}><FormattedMessage {...messages.overAll} /></div>
                                        <div className={cx(s.displayTableCell, s.textRight, 'textCenterDashboardRightRTL')}>{totalDrivers}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={s.box}>
                            ...
                            <div className={s.totalCss}>
                               <div className={s.displayTable}>
                                    <div className={s.displayTableRow}>
                                        <div className={cx(s.displayTableCell, s.widthText, s.textCenterDashboard, 'textCenterDashboardRTL')}><FormattedMessage {...messages.overAll} /></div>
                                        <div className={cx(s.displayTableCell, s.textRight, 'textCenterDashboardRightRTL')}>{totalRiders}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={s.box}>
                            ...
                            <div className={s.totalCss}>
                               <div className={s.displayTable}>
                                    <div className={s.displayTableRow}>
                                        <div className={cx(s.displayTableCell, s.widthText, s.textCenterDashboard, 'textCenterDashboardRTL')}><FormattedMessage {...messages.overAll} /></div>
                                        <div className={cx(s.displayTableCell, s.textRight, 'textCenterDashboardRightRTL')}>{totalBookings}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className={s.box}>
                            ...
                            <div className={s.totalCss}>
                               <div className={s.displayTable}>
                                    <div className={s.displayTableRow}>
                                        <div className={cx(s.displayTableCell, s.widthText, s.textCenterDashboard, 'textCenterDashboardRTL')}><FormattedMessage {...messages.overAll} /></div>
                                        <div className={cx(s.displayTableCell, s.textRight, s.priceCircle, 'textCenterDashboardRightRTL')}><CurrencyConverter from={currency} amount={totalEarnings} /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
