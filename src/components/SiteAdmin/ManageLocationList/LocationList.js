                                    ...
                                    locationList && locationList.getLocationList && locationList.getLocationList.LocationData && locationList.getLocationList.LocationData.length > 0 && locationList.getLocationList.LocationData.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td data-label={formatMessage(messages.action)}><Link to={'/siteadmin/edit-location/' + item.id} className={cx('editAlign', s.displayFlex)}><span><img src={EditIcon} className={cx(s.editIcon, 'editIconRTL')} /></span>
