...
import trackingIcon from '../../../public/Icons/trackingIcon.svg';
import mobileAppIcon from '../../../public/Icons/mobileappIcon.svg';

import manualBookingsIcon from '../../../public/Icons/manualDispatcher.svg';
            ...
            <div className={cx({ [s.menuOpen]: this.state.isOpen == 1 }, s.mobileMenu)}>
              ...
              <Nav className="mr-auto">
                ...
                }
                {
                  ...
                  <div>
                    <div id='Homepage' className={cx(s.sideNavitem, 'sideNavitemRTL')}>
                      <Button
                        bsStyle="link"
                    ...
                    <Collapse in={this.state.homepageSettings}>
                      <div>
                        <Link to={'/siteadmin/homepage/banner'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-homesettings') })} onClick={() => this.openClose()}>
                        ...
                        <Link to={'/siteadmin/homepage/category'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-citysettings') })} onClick={() => this.openClose()}>
                          <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell, s.sideNavitemCollapse, 'rightArrowRTL')}>
                            <img src={RightArrowIcon} className={cx(s.sideMenuIcon, s.sideNavitemCollapseIcon)} />
                          </span>
                          <span className={cx(s.vtrMiddle, s.sideNavitemCollapseText, s.displayTableCell, 'textAlignRightRTL')}>
                        ...
                        <Link to={'/siteadmin/homepage/topfeature'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-aboutsettings') })} onClick={() => this.openClose()}>
                          <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell, s.sideNavitemCollapse, 'rightArrowRTL')}>
                            <img src={RightArrowIcon} className={cx(s.sideMenuIcon, s.sideNavitemCollapseIcon)} />
                          </span>
                          <span className={cx(s.vtrMiddle, s.sideNavitemCollapseText, s.displayTableCell, 'textAlignRightRTL')}>
                        ...
                        <Link to={'/siteadmin/homepage/rider'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-safetysettings') })} onClick={() => this.openClose()}>
                          <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell, s.sideNavitemCollapse, 'rightArrowRTL')}>
                            <img src={RightArrowIcon} className={cx(s.sideMenuIcon, s.sideNavitemCollapseIcon)} />
                          </span>
                          <span className={cx(s.vtrMiddle, s.sideNavitemCollapseText, s.displayTableCell, 'textAlignRightRTL')}>
                        ...
                        <Link to={'/siteadmin/homepage/driver'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-signupsettings') })} onClick={() => this.openClose()}>
                          <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell, s.sideNavitemCollapse, 'rightArrowRTL')}>
                            <img src={RightArrowIcon} className={cx(s.sideMenuIcon, s.sideNavitemCollapseIcon)} />
                          </span>
                          <span className={cx(s.vtrMiddle, s.sideNavitemCollapseText, s.displayTableCell, 'textAlignRightRTL')}>
                        ...
                        <Link to={'/siteadmin/homepage/footer'} className={cx(s.sideNavitem, s.displayTable, s.sideNavitemCollapsePadding, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/homepage-footersettings') })} onClick={() => this.openClose()}>
                          <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell, s.sideNavitemCollapse, 'rightArrowRTL')}>
                            <img src={RightArrowIcon} className={cx(s.sideMenuIcon, s.sideNavitemCollapseIcon)} />
                          </span>
                          <span className={cx(s.vtrMiddle, s.sideNavitemCollapseText, s.displayTableCell, 'textAlignRightRTL')}>
                ...
                }
                {
                  ...
                  <Link to={'/siteadmin/riders'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', 'menuIconRTL', { [s.activeMenu]: location.startsWith('/siteadmin/riders') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                  ...
                  </Link>}
                {
                  ...
                  <Link to={'/siteadmin/drivers'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', 'menuIconRTL', { [s.activeMenu]: location.startsWith('/siteadmin/drivers') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                ...
                {validatePrivilege(5, privileges) && <Link to={'/siteadmin/vehicles'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/vehicles') })} onClick={() => this.openClose()}>
                  <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                  ...
                  </Link>}
                {
                  ...
                  <Link to={'/siteadmin/manual-bookings'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/manual-bookings') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                ...
                }
                {
                  ...
                  <Link to={'/siteadmin/schedule-bookings'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/schedule-bookings') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                ...
                {
                  validatePrivilege(9, privileges) &&
                  <Link to={'/siteadmin/bookings'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/bookings') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                ...
                {
                  validatePrivilege(9, privileges) &&
                  <Link to={'/siteadmin/completed-bookings'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/completed-bookings') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
                ...
                {
                  validatePrivilege(9, privileges) &&
                  <Link to={'/siteadmin/cancelled-bookings'} className={cx(s.sideNavitem, s.displayTable, 'sideNavitemRTL', { [s.activeMenu]: location.startsWith('/siteadmin/cancelled-bookings') })} onClick={() => this.openClose()}>
                    <span className={cx(s.vtrTop, s.iconWidth, s.displayTableCell)}>
