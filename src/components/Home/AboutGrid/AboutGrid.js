      ...
      <div className={s.aboutContainer}>
        <Container className={s.cotainerWith}>
          <div className={s.aboutGrid}>
            ...
            <div className={cx(s.contentOne, s.responsiveContentOne, s.noPosition, 'postionOneRTL')}>
              <h1>{homepage.aboutGridTitle1}</h1>
              <p>{homepage.aboutGridContent1}</p>
            </div>
            <div className={cx(s.contentOne, s.positionTwo, s.noPosition, 'postionTwoRTL')}>
              <h1>{homepage.aboutGridTitle2}</h1>
              <p>{homepage.aboutGridContent2}</p>
            </div>
            <div className={cx(s.contentOne, s.positionThree, s.noPosition, 'postionThreeRTL')}>
              <h1>{homepage.aboutGridTitle3}</h1>
              <p>{homepage.aboutGridContent3}</p>
            </div>
            <div className={cx(s.contentOne, s.positionFour, s.noPosition, 'postionFourRTL')}>
              <h1>{homepage.aboutGridTitle4}</h1>
              <p>{homepage.aboutGridContent4}</p>
            </div>
            <div className={cx(s.contentOne, s.positionFive, s.noPosition, 'postionFiveRTL')}>
              <h1>{homepage.aboutGridTitle5}</h1>
              <p>{homepage.aboutGridContent5}</p>
            </div>
            <div className={cx(s.contentOne, s.positionSix, s.noPosition, 'postionSixRTL')}>
