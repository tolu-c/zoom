...
import { UserProfile, Category, BookingPromoCode, BookingCancelReason, ScheduleBooking, ScheduleBookingHistory, BookingLocations } from '../../models';
...
const BookingType = new ObjectType({
    ...
    fields: {
        ...
        tipsDriverTotalFare: { type: FloatType },
        ...
        adminId: { type: StringType },
        isTripCancelledByAdmin: { type: BooleanType }
    }
});
