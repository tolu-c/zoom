...
const routes = {
  ...
  children: [
    ...
    },
    {
      ...
      load: () => import(/* webpackChunkName: 'dashboard7' */ './site-admin/chatMessage')
    },
    {
      path: '/siteadmin/manual-bookings',
      load: () => import(/* webpackChunkName: 'dashboard7' */ './site-admin/manualBooking')
    },
    {
      path: '/siteadmin/manual-bookings/create',
      load: () => import(/* webpackChunkName: 'dashboard7' */ './site-admin/createBooking')
    },
    {
      path: '/page/:pageUrl',
    ...
    },
    {
      ...
      load: () => import(/* webpackChunkName: 'dashboard20' */ './site-admin/mobileSettings')
    },
    // {
