...
export async function getBookings(keyword, status, pageType) {
    ...
    let keywordFilter = {}, tripStatusFilter = {}, cancelReasonFilter = {}, bookingTypeFilter = {}, manualBookingFilter = {};
    let attributes = [
        ['id', 'Booking ID'],
        [
    ...
    if (pageType === 'manual-bookings') {
        manualBookingFilter = { adminId: { [sequelize.Op.ne]: null } };
    }
